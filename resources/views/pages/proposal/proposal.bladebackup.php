                                ...
                                <div id="listkegiatan">
                                    ...
                                    <div class="row kegiatann">
                                        <div class="col-lg-6">
                                            ...
                                            <div id="editor4" class="editorbaru"></div>
                                            </div>
                                            </div>
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered" id="tabeldetail">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><input type="text" class="form-control" name="nama_item[]"></td>
                                                            <td><input type="text" class="form-control" name="satuan[]"></td>
                                                            <td><input type="number" class="form-control" name="quantity[]"></td>
                                                            <td><input type="number" class="form-control" name="harga_satuan[]"></td>
                                                    ...
                                                    <div class="accordion accordion-flush" id="accordionFlushExample">
                                                        ...
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body text-muted" id="kegiatan">
                                                                        {{-- data kegiatan  --}}
                                                                </div>
                                                        </div>
                                                        <div class="accordion-item">
                                                            ...
                                                            <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree"
                                                                data-bs-parent="#accordionFlushExample">
                                                                <div class="accordion-body text-muted" id="detail">
                                                                    {{-- data detail --}}
                                                                </div>
                                                            </div>
                                                        </div>
...
import {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        // ambilEditor('#editor2');
        // ambilEditor('#editor3');
        var allEditors = document.querySelectorAll('.editorbaru');
    ...
    $('#tambahkegiatan').click(function() {
        ...
        // ambilEditor('.editorbaru:last-child');
        const tanggal_awal = flatpickr(".tanggal_mulai",{});
        const tanggal_akhir = flatpickr(".tanggal_akhir",{});
        // ClassicEditor.create(document.querySelector('.editorbaru:last')).catch(error => console.error(error));
    });
...
{  
    ...
    console.log(dataEditor['.editorbaru'].getData());
    console.log(dataEditor);


    let proposalData = {};
    latarbelakang= dataEditor['#editor'].getData();
    tujuan=dataEditor['#editor2'].getData();
    peserta=dataEditor['#editor3'].getData();
    kegiatan=dataEditor['.editorbaru:last-child'].getData();
    ...
    let kegiatanData = [];
        $('.kegiatann').each(function() {
            kegiatanData.push({
                bentuk_kegiatan: kegiatan,
    ...
    let detailData = [];
        $('#detail-table tbody tr').each(function() {
            detailData.push({
                nama_item: $(this).find('.nama_item').val(),
                satuan: $(this).find('.satuan').val(),
                quantity: $(this).find('.quantity').val(),
                harga_satuan: $(this).find('.harga_satuan').val(),
                total: $(this).find('.total').val(),
                catatan: $(this).find('.catatan').val()
            });
        });
        proposalData.detail = detailData;

        let detailHTML = '<table class="table"><thead><tr><th>Nama Item</th><th>Satuan</th><th>Quantity</th><th>Harga Satuan</th><th>Total</th><th>Catatan</th></tr></thead><tbody>';
        proposalData.detail.forEach(function(item) {
            detailHTML += `
                <tr>
