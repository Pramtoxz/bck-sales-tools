    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-20">Data Jabatan</h4>
                ...
                <div class="modal-body">
                    <form class="needs-validation" novalidate action="#" id="formSubmit">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label" for="kd_departement">Kode Departement</label>
                                    <select class="form-control" id="kd_departement" name="kd_departement" required style="width:100%;">
                        ...
                        {{-- <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label class="form-label" for="kd_jabatan">Kode Jabatan</label>
                                    <input type="text" class="form-control" id="kd_jabatan" placeholder="Kode Jabatan" name="kd_jabatan" required>
                                </div>
                            </div>
                        </div> --}}
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_jabatan" placeholder="Nama Jabatan" name="nama_jabatan" required>
                                </div>
                            </div>
                        </div>
...
<script>
    ...
    function loadData(){
        ...
        dataTableMaster = $('#datatable').DataTable({
            ...
            columns: [{
                ...
                {
                    data: 'departement.deskripsi',
                    name: 'departement.deskripsi'
                },
                {
                    data: 'active',
                    name: 'active',
    ...
    function tambahData(){
        ...
        $('#tipe_submit').val("add");
        $('#id_data').val("");
        $('#kd_departement').val("").trigger("change");
        $('#kd_jabatan').val("")
        $('#nama_jabatan').val("") 
        $('#active').val("t")
    }
    ...
    function editData(id){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#kd_departement').val(data.kd_departement).trigger("change");
            },
