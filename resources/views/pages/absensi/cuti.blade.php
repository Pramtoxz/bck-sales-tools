                    ...
                    <div class="row justify-content-md-left">
                        <div class="card col-xl-3 col-sm-12 col-md-6">
                            <div class="card-body btn btn-info">
                                <h5 class="text-white font-size-14 mb-1" style="text-align: center;">Sisa Cuti Tahunan : <span class="sisacutitahunan"></span></h5>
...
{{--                         
                    ...
                    <div class="row wadah_spinner" style="display:none;">
                        <div class="col-lg-12">
                            <div class="spinner-border text-success" role="status">
                                ...
                                <span class="visually-hidden">Sedang Kirim Email... Please Wait...</span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form class="needs-validation" novalidate action="#" id="formSubmit" style="display: none">
                        ...
                        <div class="row" id="tujuan_supervisi" style="display: none">
                            <div class="col-md-12">
                                <div class="mb-1">
                                    <label class="form-label" for="perihal_cuti">Tujuan Supervisi</label>
                                    <input type="text" class="form-control" id="tempat_tujuan_supervisi" placeholder="Isikan Tempat Tujuan Supervisi" name="tempat_tujuan_supervisi" required>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        let tanggal_potong = flatpickr("#tanggalpotong", {
            mode: "multiple"
            , dateFormat: "d-m-Y"
            , minDate:"today"
        });
        ...
        var dropdownParentEl = $('#containerModal2 > .modal-dialog > .modal-content > .modal-body')
                        ...
                        if (data.status == "true") {
                            ...
                            if(data.id_cuti == "4"){
                                ...
                                if(data.status_approval=='Pending'){
                                    ...
                                    icon: 'success'
                                    , title: 'Berhasil'
                                    , text: 'Edit Data Cuti Karyawan Berhasil!'
                                    , confirmButtonText: 'OK'
                                    });
                                }
            ...
            $('#jenis_cuti').on('change', function() {
                ...
                if (tampungjenis) {
                    ...
                    if (tampungjenis == '1' || tampungjenis == '3') {
                        ...
                        $('#upload_surat').val("");
                        $('#tujuan_supervisi').val("");
                    }else if(tampungjenis == '5'){
                        $('#tampil_tanggal_cuti').show();
                        $('#tujuan_supervisi').show();
                        $('#upload_surat').prop('required', false);
                        $('#tanggal_cuti').prop('required', true);
                        $('#tanggal_cuti_range').prop('required', false);
                        tanggal_cuti_range.clear()
            ...
            dataTableMaster = $('#tabelcuti').DataTable({
                ...
                , ],
                  ...
                  createdRow: function ( row, data, index ) {
                    ...
                    }else if(data['status_approval']=='Diterima'){
                        $('td', row).eq(6).addClass('terima');
                    }else{
                        $('td', row).eq(6).addClass('batal');
                    }
                    }
        ...
        function potongCuti() {
            ...
            tanggal_potong = flatpickr("#tanggalpotong", {
            mode: "multiple"
            , dateFormat: "d-m-Y"
            , minDate:"today"
            });
        ...
        function tampilkanDetailCuti(data)
        {
            ...
            if(DataDetail[8]=='Ditolak' || DataDetail[8]=='Dibatalkan'){
                $(".status_ganti").html(DataDetail[8] + " <i class='fas fa-arrow-right'></i> " + DataDetail[13])
            }
        ...
        function reject(id) 
    {
        ...
        input: "textarea",
        inputLabel: "Berikan alasan Reject:",
            ...
            return new Promise((resolve) => {
                $.ajax({
                    ...
                    error: function (xhr) {
                        ...
                        $('#ket_failed_toast').html("Terjadi kesalahan saat mengirim data.");
                        new bootstrap.Toast(toastfailed).show();
                        resolve();
                    }
                });
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#tempat_tujuan_supervisi').val(data.tujuan_supervisi)

                if(data.id_jenis_cuti=='2'){
                    $('#datepicker-range').val(data.tgl_cuti);
                    tanggal_cuti_range.setDate(data.tgl_cuti, true);

                }else{
                    $('#datepicker-multiple').val(data.tgl_cuti);

                    tanggal_cuti.setDate(data.tgl_cuti, true);
        ...
        function deleteData(id){
            Swal.fire({
            title:"Yakin Batalkan Cuti?",
            input: "textarea",
            inputLabel:"Berikan Alasan Batal:",
            inputValidator:(value)=>{
                if(!value){
                    return 'Alasan Batal Wajib Di isi!'
                }
            },
            // text:"Status Cuti Menjadi Di batalkan, Jika Click Ya!",
            icon:"warning",
            showCancelButton:true,
            confirmButtonColor:"#2ab57d",
            cancelButtonColor:"#fd625e",
